...
### `default_progress_handler` <sup><a href="https://github.com/sasigit7/fastmcp/blob/main/src/fastmcp/client/progress.py#L12" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
